...
for seed in "${manual_seed_values[@]}"; do
    ...
    python few_shot_train.py --finetune --patients "$p2" --validation_patients "$p1" --finetune_patients "$p2"  --epochs 25
    python few_shot_train.py --finetune --patients "$p2" "$p3" --validation_patients "$p1" --finetune_patients "$p2" "$p3" --epochs 25
    python few_shot_train.py --finetune --patients "$p2" "$p3" "$p4" --validation_patients "$p1" --finetune_patients "$p2" "$p3" "$p4" --epochs 25
    python few_shot_train.py --finetune --patients "$p2" "$p3" "$p4" "$p5" --validation_patients "$p1" --finetune_patients "$p2" "$p3" "$p4" "$p5" --epochs 25

    python few_shot_train.py --manual_seed "$seed" --num_support_val 5 --patients "$p1" "$p2" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
    python few_shot_train.py --manual_seed "$seed" --num_support_val 5 --patients "$p1" "$p2" "$p3" --finetune_patients "$p2" "$p3" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
    python few_shot_train.py --manual_seed "$seed" --num_support_val 5 --patients "$p1" "$p2" "$p3"  "$p4" --finetune_patients "$p2" "$p3"  "$p4"  --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
    python few_shot_train.py --manual_seed "$seed" --num_support_val 5 --patients "$p1" "$p2" "$p3"  "$p4" "$p5" --finetune_patients "$p2" "$p3"  "$p4"  --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"


    for num_support in "${num_support_val_values[@]}"; do
        # Run the Python script with the given arguments

        python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p3" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
        python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p4" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
	python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p5" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
	
        python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p3" "$p4" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
	python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p4" "$p5" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
	python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p3" "$p5" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"

	python few_shot_train.py --manual_seed "$seed" --num_support_val "$num_support" --patients "$p1" "$p2" "$p3" "$p4" "$p5" --finetune_patients "$p2" --excluded_patients "$p1" "$p2" "$p3" "$p4" "$p5"
